...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" },            "m",     function () awful.util.spawn("./script/rofi/browser_bookmark.sh") end,
              {description = "open bookmark of browser", group = "launcher"}),

    awful.key({ modkey, "Shift" },            "b",     function () awful.util.spawn("./script/rofi/surfraw.sh") end,
              {description = "run surfraw", group = "launcher"}),

    awful.key({ modkey, "Shift" },            "e",     function () awful.util.spawn("/usr/bin/rofi -show emoji -modi emoji") end,
              {description = "choose emoji", group = "launcher"}),

    awful.key({ modkey, "Shift" },            "c",     function () awful.util.spawn("./script/rofi/edit_configs.sh") end,
