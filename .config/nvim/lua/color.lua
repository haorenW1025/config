...
Group.new("Keyword",        colors.nord_9,       colors.none, styles.NONE)
...
Group.new("CursorLine", colors.none, colors.nord_1)
...
Group.new("PMenuSel", colors.nord_0, colors.nord_8)
...
Group.new("Visual",colors.nord_3_light, colors.nord_1)
